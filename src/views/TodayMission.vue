...
<template lang="pug">
.missionCenter
    el-table(:data='tableData', max-height='600', stripe='', style='width: 100%', :default-sort='{prop: "begin"}')
        ...
        el-table-column(align="center", sortable='', label='状态', width='105px', 
            :filters="[{text: '未开始', value: '未开始'}, {text: '进行中', value: '进行中'}, {text: '暂停中', value: '暂停中'}]", :filter-method='filterHandler')
        ...
        el-table-column(label='', align="center", width='250px', @click='statusChange(statusScope.row)')
            ...
            template(slot-scope='scope', slot="header")
                el-button.switchText(@click="$router.push({name:'MissionCenter'})", size='medium') 查看所有事务
